...
public class DateUtils {
   ...
   // String myInvoiceRoundOffDateAndTime = myInvoiceDateTimeFormatter.format(myInvoiceDate);
	...
	/*
	 * public static Date stringddMMYYYYToDateConvert(String inputDate) { Date date
	 * = new Date(); try { date = new
	 * SimpleDateFormat("dd-MM-yyyy").parse(inputDate); } catch (ParseException e) {
	 * // TODO Auto-generated catch block e.printStackTrace(); } return date; }
	 */
